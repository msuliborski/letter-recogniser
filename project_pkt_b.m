digitDatasetPath = fullfile('Folder_2');
...
[imdsTrain,imdsRest] = splitEachLabel(imds, 140, 'randomize');
[imdsValidation, imdsTest] = splitEachLabel(imdsRest, 30, 'randomize');
