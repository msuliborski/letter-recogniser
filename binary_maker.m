...
function test
  convFolderToBinary('set_custom\A');
  convFolderToBinary('set_custom\E');
  convFolderToBinary('set_custom\I');
  convFolderToBinary('set_custom\O');
  convFolderToBinary('set_custom\U');
